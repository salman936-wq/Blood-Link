...
import { updateBloodRequest } from "@/lib/api/action/editBlodRequest";
...
const DonationReqForm = ({ donorId, defaultValueOld, donerRole }) => {
    ...
    const { register, handleSubmit, setValue, watch } = useForm({
        defaultValues: {
            patientName: defaultValueOld.patientName,
            requiredDateTime: defaultValueOld.requiredDateTime,
            hospitalName: defaultValueOld.hospitalName,
            unitsNeeded: defaultValueOld.unitsNeeded,
            division: defaultValueOld.division,
            district: defaultValueOld.district,
            bloodGroup: defaultValueOld.bloodGroup,
            urgency: defaultValueOld.urgency,
            notes: defaultValueOld.notes,
        },
    });
    ...
    const onSubmit = async (data) => {
        ...
        const res = await updateBloodRequest(defaultValueOld._id, finalData);


        if (res.modifiedCount > 0) {
            toast.success("Request updated successfully");
            router.push(`/dashboard/${donerRole}/blood-request/${defaultValueOld._id}`); // App Router
        }
