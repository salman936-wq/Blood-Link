export default function Select({ label, icon: Icon, options = [], placeholder, error, className = "", ...props }) {
  return (
    <label className="form-control w-full">
      ...
      >
        ...
        <select className="select select-ghost w-full bg-transparent p-0 text-sm focus:outline-none" defaultValue="" {...props}>
